...
### 1. Graduation Insights – Everything Data Capstone (Power BI & Excel)
Analyzed graduation outcomes for mentorship participants to identify performance trends
and factors influencing successful completion.
- Tools: Power BI, Excel, DAX  
- Focus: Educational analytics, cohort performance, insights reporting  
👉 [View Project](https://github.com/yourusername/powerbi-graduation-insights)
...
👉 [View Project](https://github.com/yourusername/excel-customer-churn-analysis)
...
👉 [View Project](https://github.com/yourusername/powerbi-sales-insights-atliq)
